...
function BVH_Create_Node(workList, aabb_array, idParent, isLeftBranch)
{
        ...
        else if (workList.length > 1)
        {
                ...
                spatialAverage.copyFrom(currentMinCorner);
                spatialAverage.addInPlace(currentMaxCorner);
                spatialAverage.scaleInPlace(0.5);
                ...
                centroidAverage.copyFrom(spatialAverage);
